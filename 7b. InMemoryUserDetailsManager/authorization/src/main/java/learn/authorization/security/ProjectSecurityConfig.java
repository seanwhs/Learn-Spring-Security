...
public class ProjectSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        ...
        var user1 = User.withUsername("happy@example.com")
                .password("12345")
                // .authorities("VIEWACCOUNT", "VIEWBALANCE", "VIEWLOANS", "VIEWCARDS" )
                // .authorities("VIEWACCOUNT")
                .roles("ADMIN")
                .build();
        var user2 = User.withUsername("sad@example.com")
                .password("12345")
                .roles("USER")
                .build();
